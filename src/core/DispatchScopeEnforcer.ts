...
const TYPE_TO_SCOPE: Record<Dispatch['type'], DispatchScopeTier> = {
  lesson: 'context',
  strategy: 'context',
...
const SCOPE_MIN_PROFILE: Record<DispatchScopeTier, AutonomyProfileLevel | 'never'> = {
...
const PROFILE_ORDER: Record<AutonomyProfileLevel, number> = {
  cautious: 0,
  supervised: 1,
  collaborative: 2,
  autonomous: 3,
